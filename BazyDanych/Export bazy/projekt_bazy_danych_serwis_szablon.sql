...
CREATE TABLE `serwis_szablon` (
  ...
  CONSTRAINT `serwis_szablon_ibfk_1` FOREIGN KEY (`katalog_id`) REFERENCES `katalog` (`id`),
  CONSTRAINT `serwis_szablon_ibfk_2` FOREIGN KEY (`szablon_id`) REFERENCES `szablon` (`id`)
